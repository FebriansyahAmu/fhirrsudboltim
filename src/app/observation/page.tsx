/**
 * app/observation/page.tsx
 *
 * Halaman modul Observation (hasil observasi & tanda vital).
 * Struktur konsisten dengan app/condition/page.tsx (panel bertab).
 *
 * Alur:
 *   1. Panel SIMGOS bertab (10 jenis observasi) — read-only, filter tanggal,
 *      highlight "Menunggu Encounter".
...
import ObservationForm from "@/app/components/modules/observation/ObservationForm";
...
import ObservationSyncPanel from "@/app/components/ihs/ObservationSyncPanel";
...
> = {
  POST: {
    ...
    desc: "Kirim hasil observasi (terkait Encounter) ke Satu Sehat.",
    color: "teal",
    endpoint: "POST /Observation",
  },
  GET: {
    title: "Ambil Data Observasi",
    desc: "Cari Observation berdasarkan ID, pasien, atau encounter.",
    color: "blue",
    endpoint: "GET /Observation",
  },
  PUT: {
    title: "Perbarui Observasi (Penuh)",
    desc: "Timpa seluruh resource Observation yang sudah ada.",
    color: "amber",
    endpoint: "PUT /Observation/:id",
  },
  PATCH: {
    title: "Perbarui Observasi (Sebagian)",
    desc: "Perbarui sebagian field Observation (mis. nilai).",
    color: "violet",
    endpoint: "PATCH /Observation/:id",
  },
};
  ...
  return (
    ...
    >
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-xl font-bold text-slate-900">Observation</h1>
                <span className="text-[10px] font-bold px-2 py-1 rounded-full bg-teal-100 text-teal-700">
                  FHIR R4
                </span>
              </div>
              <p className="text-sm text-slate-500 mt-0.5">
                Hasil observasi & tanda vital — Satu Sehat Integration
              </p>
            </div>
          </div>
        ...
        <ObservationSyncPanel onUsePayload={handleUsePayload} />
        ...
        {/* ── 5. Log Pengiriman ── */}
        <DeliveryLogTable resourceType="Observation" />
      </div>
    </DashboardLayout>
  );
}
