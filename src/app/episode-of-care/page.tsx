/**
 * app/episode-of-care/page.tsx
 *
 * Halaman modul EpisodeOfCare.
 * Pola 100% konsisten dengan:
...
> = {
  POST: {
    title: "Buat EpisodeOfCare Baru",
    desc: "Daftarkan episode perawatan pasien baru ke Satu Sehat.",
    color: "teal",
    endpoint: "POST /EpisodeOfCare",
  },
  GET: {
    title: "Ambil Data EpisodeOfCare",
    desc: "Ambil episode perawatan berdasarkan ID atau parameter filter.",
    color: "blue",
    endpoint: "GET /EpisodeOfCare",
  },
  PUT: {
    title: "Perbarui EpisodeOfCare (Penuh)",
    desc: "Timpa seluruh resource EpisodeOfCare yang sudah ada.",
    color: "amber",
    endpoint: "PUT /EpisodeOfCare/:id",
  },
  PATCH: {
    title: "Perbarui EpisodeOfCare (Sebagian)",
    desc: "Perbarui sebagian field EpisodeOfCare.",
    color: "violet",
    endpoint: "PATCH /EpisodeOfCare/:id",
  },
};

/**
 * Kelas Tailwind untuk info bar — didefinisikan eksplisit
 * agar tidak terpotong oleh Tailwind PurgeCSS.
 */
  ...
  return (
    ...
    >
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">
                Manajemen episode perawatan pasien — Satu Sehat Integration
              </p>
            </div>
          </div>
        ...
        {/* ── 5. Log Pengiriman ── */}
        <DeliveryLogTable resourceType="EpisodeOfCare" />
      </div>
    </DashboardLayout>
  );
}
