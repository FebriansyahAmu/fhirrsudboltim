 ...
 *
 * Halaman modul ServiceRequest (Permintaan Radiologi).
...
import ServiceRequestForm from "@/app/components/modules/service-request/ServiceRequestForm";
...
import ServiceRequestSyncPanel from "@/app/components/ihs/ServiceRequestSyncPanel";
...
> = {
  POST: {
    title: "Buat Permintaan Radiologi",
    desc: "Kirim ServiceRequest pemeriksaan radiologi ke Satu Sehat.",
    color: "teal",
    endpoint: "POST /ServiceRequest",
  },
  GET: {
    title: "Ambil Data Permintaan",
    desc: "Ambil ServiceRequest berdasarkan ID atau filter pasien/status.",
    color: "blue",
    endpoint: "GET /ServiceRequest",
  },
  PUT: {
    title: "Perbarui Permintaan (Penuh)",
    desc: "Timpa seluruh resource ServiceRequest yang sudah ada.",
    color: "amber",
    endpoint: "PUT /ServiceRequest/:id",
  },
  PATCH: {
    title: "Perbarui Permintaan (Sebagian)",
    desc: "Perbarui sebagian field ServiceRequest.",
    color: "violet",
    endpoint: "PATCH /ServiceRequest/:id",
  },
};
  ...
  return (
    ...
    >
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">
                Permintaan pemeriksaan radiologi — Satu Sehat Integration
              </p>
            </div>
          </div>
        ...
        <ServiceRequestSyncPanel onUsePayload={handleUsePayload} />
        ...
        {/* ── 5. Log Pengiriman ── */}
        <DeliveryLogTable resourceType="ServiceRequest" />
      </div>
    </DashboardLayout>
  );
}
