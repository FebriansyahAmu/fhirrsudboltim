...
> = {
  POST: {
    ...
    desc: "Tambahkan data kunjungan pasien (Encounter) ke Satu Sehat.",
    color: "teal",
    endpoint: "POST /Encounter",
  },
  GET: {
    title: "Ambil Data Kunjungan",
    desc: "Ambil data kunjungan berdasarkan ID atau parameter filter.",
    color: "blue",
    endpoint: "GET /Encounter",
  },
  PUT: {
    title: "Perbarui Kunjungan (Penuh)",
    desc: "Timpa seluruh resource Encounter yang sudah ada.",
    color: "amber",
    endpoint: "PUT /Encounter/:id",
  },
  PATCH: {
    title: "Perbarui Kunjungan (Sebagian)",
    desc: "Perbarui sebagian field Encounter.",
    color: "violet",
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-11 h-11 rounded-2xl bg-linear-to-br from-blue-100 to-cyan-100 border border-blue-200 flex items-center justify-center text-2xl shrink-0 shadow-sm">
              🏥
            </div>

            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-xl font-bold text-slate-900">Encounter</h1>
                <span className="text-[10px] font-bold px-2 py-1 rounded-full bg-blue-100 text-blue-700">
                  FHIR R4
                </span>
              </div>
              <p className="text-sm text-slate-500 mt-0.5">
                Kunjungan & episode pelayanan pasien — Satu Sehat Integration
              </p>
            </div>
          </div>
        ...
        {/* ── 5. Log Pengiriman ── */}
        <DeliveryLogTable resourceType="Encounter" />
      </div>
    </DashboardLayout>
  );
}
