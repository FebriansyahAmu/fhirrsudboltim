...
// Satu resource ServiceRequest, beberapa jenis tindakan — masing-masing modul
// registry sendiri (tabel/filter berbeda). Semua butuh Encounter untuk dikirim.
const TABS: { key: string; label: string; icon: string; hint: string }[] = [
  { key: "servicerequest-lab", label: "Laboratorium", icon: "🧪", hint: "Tindakan LAB" },
  { key: "servicerequest-jadwal", label: "Jadwal Kontrol", icon: "📅", hint: "Kontrol ulang" },
  { key: "servicerequest-ekg", label: "Pemeriksaan EKG", icon: "🫀", hint: "Rekam jantung" },
  {
    key: "servicerequest-ranap",
    label: "Rencana Rawat Inap",
    icon: "🏨",
    hint: "Surat perintah rawat inap",
  },
];

export default function ServiceRequestSyncPanel({
  onUsePayload,
}: {
    ...
    <div className="space-y-3">
      <div>
        <p className="mb-2 flex items-center gap-1.5 text-xs font-semibold text-slate-500">
          ...
          Jenis Service Request — pilih yang ingin dikirim
        </p>
        <div
          role="tablist"
          aria-label="Jenis Service Request"
