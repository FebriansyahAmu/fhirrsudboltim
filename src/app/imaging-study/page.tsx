/**
 * app/imaging-study/page.tsx
 *
 * Halaman modul ImagingStudy — fokus pencarian (GET).
...
import ImagingStudyForm from "@/app/components/modules/imaging-study/ImagingStudyForm";
...
> = {
  GET: {
    title: "Cari Data ImagingStudy",
    desc: "Cari studi pencitraan berdasarkan pasien, kunjungan, tanggal, status, atau modality.",
    color: "blue",
    endpoint: "GET /ImagingStudy",
  },
};
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-11 h-11 rounded-2xl bg-linear-to-br from-sky-100 to-indigo-100 border border-sky-200 flex items-center justify-center text-2xl shrink-0 shadow-sm">
              🩻
            </div>
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-xl font-bold text-slate-900">ImagingStudy</h1>
              ...
              <p className="text-sm text-slate-500 mt-0.5">
                Pencarian studi pencitraan radiologi — Satu Sehat Integration
              </p>
            </div>
          </div>
        ...
        {/* ── 5. Log Pengiriman ── */}
        <DeliveryLogTable resourceType="ImagingStudy" />
      </div>
    </DashboardLayout>
  );
}
